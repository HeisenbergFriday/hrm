...
| 验证 | 身份合并定向测试 12/12、最终表回归 75/75、runner 测试 18/18 通过，`py_compile`、`git diff --check` 通过。使用真实 8 月输入生成后，代码规则范围内输出 312 人：员工类型 312、人员分类 271、入职日期 310、离职日期 41、转正日期 271 条非空；公式错误 0。 |
